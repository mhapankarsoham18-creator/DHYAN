...
def test_alert_price_above_triggers() -> None:
    ...
    engine._evaluate_condition(alert, 1505, db) # type: ignore
...
def test_alert_price_above_does_not_trigger() -> None:
    ...
    engine._evaluate_condition(alert, 1499, db) # type: ignore
...
def test_alert_price_below_triggers() -> None:
    ...
    engine._evaluate_condition(alert, 1490, db) # type: ignore
...
def test_alert_price_below_does_not_trigger() -> None:
    ...
    engine._evaluate_condition(alert, 1501, db) # type: ignore
